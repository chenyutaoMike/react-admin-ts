...
const routers = [
  {
    path: '/console', title: '控制台', icon: 'ClockCircleOutlined', SubMenu: true, children: [
      { path: '/consoleIndex', title: '首页', component: Console }
    ]
  },
  {
    path: '/info', title: '信息管理', icon: 'CopyOutlined', SubMenu: true, children: [
      { path: '/infoIndex', title: '信息列表', component: InfoIndex },
      { path: '/category', title: '信息分类', component: Category },
    ]
  },
  {
    path: '/user', title: '用户管理', icon: 'UserOutlined', SubMenu: true, children: [
